...
function harness(){
 ...
 const answer=(id,error=null)=>{for(const p of pending.filter(p=>p.id===id))p.resolve({data:error?null:p.name==='family_live_dashboard'?{selectedStudent:{id}}:{records:[{id}]},error});};
