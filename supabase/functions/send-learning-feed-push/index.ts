...
type Body={kind:"class"|"correction"|"comment"|"reply";sourceKey:string;studentIds:string[];date:string;title?:string;body?:string;url?:string;recipientProfileId?:string};
