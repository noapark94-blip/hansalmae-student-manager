    ...
    <main className="app-shell">
      ...
      <section className="workspace">
        ...
        <div className="content">
          ...
          {view === "students" && <div className="student-page-layout">{profile.role==="admin"&&<StudentLifecycleDashboard supabase={supabase} filter={studentStatusFilter} onFilter={setStudentStatusFilter}/>}<Students rows={filteredStudents} total={students.length} filteredTotal={filteredStudents.length} statusFilter={studentStatusFilter} loading={studentsLoading} error={studentsError} query={query} setQuery={setQuery} onRegister={() => void refreshStudentRegistrationCatalog().then((ready)=>ready&&setRegistrationOpen(true))} onOpen={openStudentDetails} /></div>}
