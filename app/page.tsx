...
const TeacherScheduleHub=dynamic(()=>import("./teacher-schedule-hub").then(module=>module.TeacherScheduleHub),{loading:()=> <FamilyLoading/>});
const AttendanceBoard=dynamic(()=>import("./attendance-board").then(module=>module.AttendanceBoard),{loading:()=> <FamilyLoading/>});
const MakeupBoard=dynamic(()=>import("./makeup-board").then(module=>module.MakeupBoard),{loading:()=> <FamilyLoading/>});
const AssignmentBoard=dynamic(()=>import("./assignment-board").then(module=>module.AssignmentBoard),{loading:()=> <FamilyLoading/>});
const ConsultationBoard=dynamic(()=>import("./consultation-board").then(module=>module.ConsultationBoard),{loading:()=> <FamilyLoading/>});
const CommunicationBoard=dynamic(()=>import("./communication-board").then(module=>module.CommunicationBoard),{loading:()=> <FamilyLoading/>});
const SettingsBoard=dynamic(()=>import("./settings-board").then(module=>module.SettingsBoard),{loading:()=> <FamilyLoading/>});
import { AccountDeletionPanel } from "./account-deletion-panel";
import { MyAccount } from "./my-account";
const StudentDetailHub=dynamic(()=>import("./student-detail-hub").then(module=>module.StudentDetailHub),{loading:()=> <FamilyLoading/>});
...
const BulkImportBoard=dynamic(()=>import("./bulk-import-board").then(module=>module.BulkImportBoard),{loading:()=> <FamilyLoading/>});
const BulkAccountBoard=dynamic(()=>import("./bulk-account-board").then(module=>module.BulkAccountBoard),{loading:()=> <FamilyLoading/>});
import { SidebarNavigation } from "./sidebar-navigation";
import { reorderById, useSortableOrder } from "./use-sortable-order";
const BulkRegistrationGuide=dynamic(()=>import("./bulk-registration-guide").then(module=>module.BulkRegistrationGuide),{loading:()=> <FamilyLoading/>});
...
const TeacherClassWorkspace=dynamic(()=>import("./teacher-class-workspace").then(module=>module.TeacherClassWorkspace),{loading:()=> <FamilyLoading/>});
import type { WeeklyTimetableRow } from "./weekly-timetable";
const AlimtalkSendCenter=dynamic(()=>import("./alimtalk-send-center").then(module=>module.AlimtalkSendCenter),{loading:()=> <FamilyLoading/>});
...
const GradeProgressionBoard=dynamic(()=>import("./grade-progression-board").then(module=>module.GradeProgressionBoard),{loading:()=> <FamilyLoading/>});
