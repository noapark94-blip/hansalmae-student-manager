...
function roleLabel(role:string){return({admin:"관리자",sub_admin:"부관리자",teacher:"교사",assistant:"조교",manager:"실장님",student:"학생",guardian:"학부모"} as Record<string,string>)[role]??role;}
