...
type State={items:Reminder[];error:string;loading:boolean;refresh:()=>Promise<void>;ack:(r:Reminder)=>Promise<void>;open:(r:Reminder)=>void};
...
function ActiveProvider({supabase,profile,children}:{supabase:SupabaseClient;profile:Profile;children:ReactNode}){
 ...
 return <Context.Provider value={{items,error,loading,refresh,ack,open:setSelected}}>{children}
