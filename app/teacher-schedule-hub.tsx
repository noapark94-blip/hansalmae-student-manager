...
function saveErrorMessage(message: string, fallback: string) { return message.includes("같은 시간") || message.includes("같은 시각") || message.includes("같은 첨삭") || message.includes("겹치는 수업") || message.includes("이미 배정") || message.includes("이미 있") || message.includes("늦어야") ? message : fallback; }
