...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/app-icon-192-v9.png", sizes: "192x192", type: "image/png" },
      { url: "/app-icon-512-v9.png", sizes: "512x512", type: "image/png" },
    ],
    apple: [{ url: "/apple-touch-icon-v9.png", sizes: "180x180", type: "image/png" }],
  },
