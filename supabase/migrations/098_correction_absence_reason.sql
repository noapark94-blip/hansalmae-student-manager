-- 첨삭 출결에도 클래스 출결과 동일하게 결석 사유를 보관한다.
...
revoke all on function public.staff_save_correction_report_v2(uuid,date,time,time,text,integer,text,text,text,text,numeric,numeric,text,text,text,text,text,text,text,boolean) from public;
