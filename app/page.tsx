...
export default function Home() {
  ...
  return (
    <main className="app-shell">
      ...
      {registrationOpen && <StudentRegistrationModal classes={academyClasses} schools={academySchools} onAddSchool={addRegistrationSchool} onClose={() => setRegistrationOpen(false)} onSubmit={registerStudent} />}
...
function StudentRegistrationModal({ classes,schools,onAddSchool,onClose, onSubmit }: { classes:AcademyClass[];schools:SchoolOption[];onAddSchool:(name:string)=>Promise<string>;onClose: () => void; onSubmit: (values: StudentFormValues) => Promise<void> }) {
